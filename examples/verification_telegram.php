<?php
/**
 * Send a verification telegram message; the number is read from console
 *
...
try {
    ...
    $verification->setType($verification::TYPE_TELEGRAM);
    $verification->setIssuer('Twizo PHP Library');
    $verification->send();

    $messageId = $verification->getMessageId();

    print 'Telegram verification send with message id: ' . $messageId . PHP_EOL;
