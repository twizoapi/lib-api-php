<?php
/**
 * Send a verification facebook messenger message; the number is read from console
 *
...
try {
    ...
    $verification->setType($verification::TYPE_FACEBOOK_MESSENGER);
    $verification->setIssuer('Twizo PHP Library');
    $verification->send();

    $messageId = $verification->getMessageId();

    print 'Facebook messenger verification send with message id: ' . $messageId . PHP_EOL;
